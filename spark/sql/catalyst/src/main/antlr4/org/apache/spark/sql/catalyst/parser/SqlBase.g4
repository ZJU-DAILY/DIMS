...
statement
    ...
    | CREATE MCHORD INDEX indexIdentifier=identifier ON
        tableIdentifier '(' column=identifier ')'                      #createMchordIndex
    | DROP MCHORD INDEX indexIdentifier=identifier ON tableIdentifier  #dropMchordIndex
    | SHOW MCHORD INDEXES                                              #showMchordIndexes
...
valueExpression
    ...
    | metricSimilarityExpression KNN count=number                                            #metricSimilarityWithKNN
...
metricSimilarityExpression
    : function=metricSimilarityFunction '(' leftTable=primaryExpression ',' rightTable=primaryExpression ')'
    | function=metricSimilarityFunction '(' leftTrajectory=metricExpression ',' rightTable=primaryExpression ')'
    | function=metricSimilarityFunction '(' leftTable=primaryExpression ',' rightTrajectory=metricExpression ')'
    ;



metricPointExpression
    : METRICPOINT '(' coords+=number (',' coords+=number)* ')'
    ;

metricExpression
    : METRIC '(' points+=metricPointExpression (',' points+=metricPointExpression)* ')'
    ;
constant
    : NULL                                                                                     #nullLiteral
