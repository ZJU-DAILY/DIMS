...
import org.apache.spark.sql.execution.amds.algorithms.MetricInsertAlgorithms
import org.apache.spark.sql.execution.amds.sql.AMDSIternalRow
import org.apache.spark.sql.execution.{SparkPlan, UnaryExecNode}

case class AMDSInsertExec(leftQuery: Point[Any], rightKey: Expression,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    ...
    logWarning(s"AMDS Insert Time: ${end - start} ms")
