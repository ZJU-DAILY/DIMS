...
import org.apache.spark.sql.execution.mchord.algorithms.MetricInsertAlgorithms
...
case class MetricInsertExec(leftQuery: Point[Any], rightKey: Expression,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    ...
    val answerRDD = search.search(sparkContext, leftQuery, rightMchordRDD)
    end = System.currentTimeMillis()
    logWarning(s"M-Chord Insert Time: ${end - start} ms")
