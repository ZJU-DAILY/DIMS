...
import org.apache.spark.sql.execution.dims.algorithms.MetricInsertAlgorithms
...
case class DIMSInsertExec(leftQuery: Point[Any], rightKey: Expression,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    ...
    logWarning(s"DIMS Insert Time: ${end - start} ms")
