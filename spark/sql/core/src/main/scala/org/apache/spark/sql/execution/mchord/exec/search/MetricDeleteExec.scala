...
import org.apache.spark.sql.execution.mchord.algorithms.MetricDeleteAlgorithms
...
case class MetricDeleteExec(leftQuery: Point[Any], rightKey: Expression,
  ...
  protected override def doExecute(): RDD[InternalRow] = {
    ...
    logWarning(s"M-Chord Delete Time: ${end - start} ms")
